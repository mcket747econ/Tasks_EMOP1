...
*** Load data 
use "$project/data/EMOP_Depenses_passage_2011_2017.dta", clear
	* This data set is created by /home/sakina/Dropbox/Mining-Mali/do-file/Consumption_by_season_Cleaning_EMOP_NT.do

*** Append 2018 and 2019 data
append using "$modData/EMOP_Depenses_2018.dta" "$modData/EMOP_Depenses_2019.dta"
...
preserve
use "C:\Users\mcket\Dropbox\Mining-Mali\data\cleaned\EMOP\emop_indivitus_2011_2019_cl.dta", clear
