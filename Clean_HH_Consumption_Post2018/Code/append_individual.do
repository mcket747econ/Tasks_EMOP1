...
* 2019
use "$input/EMOP_2019_Individus.dta", clear
gen year = 2019
tempfile append_2019
save `append_2019'
	
* 2018
use "$input/EMOP_2018_Individus.dta", clear
gen year = 2018
...
* 2016
use "$input/EMOP_2016_Individus.dta", clear
gen year = 2016

preserve // Bring in the household weights
	use "$input/EMOP_Menage_2016.dta", clear
	rename W1 hhweight
	keep idmenage hhweight
...
* 2015
use "$input/EMOP_2015_Individus.dta", clear
gen year = 2015

preserve // Bring in the household weights
	use "$input/EMOP_Menage_2015.dta", clear
	rename W1 hhweight
	keep idmenage hhweight
...
* 2014
use "$input/EMOP_2014_Individus.dta", clear
gen year = 2014
rename cercle arrond commune, proper

preserve // Bring in the household weights
	use "$input/EMOP_Menage_2014.dta", clear
	rename W1 hhweight
	keep idmenage hhweight
...
* 2013
use "$input/EMOP_2013_Individus.dta", clear
gen year = 2013
rename region cercle arrond commune milieu, proper

preserve // Bring in the household weights
	use "$input/EMOP_Menage_2013.dta", clear
	rename W1 hhweight
	keep idmenage hhweight
...
preserve
	use "$input/EMOP_GPS.dta", replace
...
save "$output/emop_indivitus_2011_2019.dta", replace
...
save "$output/emop_indivitus_2011_2019_cl.dta", replace
